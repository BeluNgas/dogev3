...
developerNo = '601136151330'
developerName= '🐦BeluNgas'
...
buttonText: 'MENU 📃',
footerText: `*${botname}*`,
description: `Hi Friend @${senderr.split('@')[0]}, Please select the menu here Remember! no spam ok`,
sections: [
{
"title": `${tanggal} - ${time}`,
rows: [
...
│${gaya2} ${prefix}contact _numberx|Name_
...
reply(`${err}`)
	...
	DogeXeonOP.sendMessage(`${owner}@s.whatsapp.net`, `─────「 *ALERT-ERROR* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "BelluNgas",body:"Dont forget to subscribe Xeon",previewType:"PHOTO",thumbnail:fs.readFileSync('./media/dogepic1.jpg'),sourceUrl:"https://wa.me/601136151330"}}})
        }
	// console.log(e)
	}
}
